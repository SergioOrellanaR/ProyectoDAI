      ...
      <div class="container" >
        <div class="row">
          ...
          <div class="col-md-5 element-animate">            
            ...
            <p class="mb-5">Avenida Pajaritos <br> Dpto. 721 <br> Santiago, Chile</p>
            
            <h5 class="text-uppercase mb-3">Envianos un Email</h5>
            ...
            <p class="mb-5">Telefono (+2)3168524 <br> Celular (+569)95285478</p>
          </div>
        </div>
      </div>
    </section>
