        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarsExample05">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="registrarMuestra.php">Registar Muestra</a>
              </li>
              <li class="nav-item">
            ...
            <form action="#" method="post">
              <div class="row">
                <div class="col-md-5 form-group">
                  <label for="txtCodigo">Codigo Paciente</label>
                  <input type="text" class="form-control form-control-lg" id="txtCodigo" required>
                </div>
              </div>
              <div class="row">
                <div class="col-md-5 form-group">
                  <label for="txtTemperatura">Temperatura</label>
                  <input type="text" id="txtTemperatura" class="form-control form-control-lg" required>
                </div>
              </div>
              <div class="row">
                <div class="col-md-5 form-group">
                  <label for="txtCantidad">Cantidad</label>
                  <input type="text" id="txtCantidad" class="form-control form-control-lg" required>
                </div>
              </div>     
              <div class="row">
