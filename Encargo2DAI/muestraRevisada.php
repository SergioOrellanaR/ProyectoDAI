...
<html lang="en">
  ...
  <body>
    ...
    <section class="section">
      <div class="container" >
        <h4>Datos de la muestra revisada</h4>
        <table class="table table-hover" id="tblPacientes">
            <tr><th scope="col">Datos</th><th>Resultado</th></tr>
            <tr><td scope="col">ID de la muestra</td><td><?php echo $resultadoAnalisis->id_analisis_muestra ?></td></tr>
